...
//ORBSTATION SPRITE ACCESSORIES
//Placing this section at the very bottom in the hopes that it prevents as many merge conflicts as possible.
/datum/sprite_accessory/tails/vox
	icon = 'orbstation/icons/mob/species/vox/bodyparts.dmi'
	color_src = FALSE
...
/datum/sprite_accessory/tails/vox/feather
	name = "Tailfeather"
	icon_state = "tailfeather"

/datum/sprite_accessory/vox_head_quills
	icon = 'orbstation/icons/mob/species/vox/vox_quills.dmi'
	color_src = null
...
/datum/sprite_accessory/vox_neck_quills/colonial
	name = "Colonial"
	icon_state = "colonial"
